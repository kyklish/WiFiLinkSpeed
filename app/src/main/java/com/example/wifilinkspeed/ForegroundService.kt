...
//			.setTicker(getString(R.string.notification_ticker_text))
			...
			// TODO: merge with 'master' to add launch activity from notification
			// if it's not work read this: "android - How To Start An Activity From Background in Android 10 (READ LAST COMMENT deep linking) - Stack Overflow.rar"
			.build()
	}
